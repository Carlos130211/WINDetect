    ...
    <PublicShell>
      <section className="mx-auto max-w-7xl px-4 py-14 sm:px-8 sm:py-20 lg:px-10 lg:py-28">
        <div className="max-w-3xl">
          ...
          <h1 className="mt-4 text-3xl font-extrabold tracking-[-0.04em] sm:text-5xl lg:text-6xl">Entender tu conexion no deberia ser complicado.</h1>
        ...
        <Link href="/diagnostico" className="group mt-12 inline-flex w-full items-center justify-center gap-3 rounded-xl bg-win-orange px-5 py-3.5 text-sm font-bold sm:w-auto">Probar mi conexion <ArrowRight className="h-4 w-4 transition-transform group-hover:translate-x-1" /></Link>
      </section>
    </PublicShell>
  );
}
