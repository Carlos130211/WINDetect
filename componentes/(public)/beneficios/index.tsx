  ...
  return (
    <PublicShell>
      <section className="mx-auto max-w-7xl px-5 py-20 sm:px-8 lg:px-10 lg:py-28">
        <div className="max-w-3xl"><p className="text-xs font-bold uppercase tracking-[0.2em] text-cyan-300">Mas que una prueba</p><h1 className="mt-4 text-4xl font-extrabold tracking-[-0.04em] sm:text-6xl">No se trata solo de ver numeros.</h1><p className="mt-6 text-lg leading-8 text-slate-400">WINDetect transforma los datos de conectividad en informacion que cualquier persona puede comprender.</p></div>
        ...
        <Link href="/diagnostico" className="group mt-12 inline-flex items-center gap-3 rounded-xl border border-cyan-300/20 bg-cyan-300/[0.06] px-5 py-3.5 text-sm font-bold text-cyan-200">Conocer mi conexion <ArrowRight className="h-4 w-4 transition-transform group-hover:translate-x-1" /></Link>
      </section>
    </PublicShell>
  );
}
